                ...
                <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    <Link href='/moh'>
                        <div className='py-3 lg:pt-5 h-[180px] lg:h-[130px] shadow-xl rounded-xl hover:scale-105 ease-in duration-300 backdrop-blur-sm bg-white/70  drop-shadow-md'>
                            <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 justify-center items-center'>
                                <div className='m-auto'>
                                <Image src='/Assets/moh.png' width='94' height='94' alt='/' className='rounded-lg'/>
                                </div>
                                <div className='flex flex-col items-center justify-center'>
                    ...
                    <Link href='/woman'>
                        <div className='py-3 lg:pt-5 h-[180px] lg:h-[130px] shadow-xl rounded-xl hover:scale-105 ease-in duration-300 backdrop-blur-sm bg-white/70  drop-shadow-md'>
                            <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 justify-center items-center'>
                                <div className='m-auto'>
                                <Image src='/Assets/women.png' width='94' height='94' alt='/' className='rounded-lg'/>
                                </div>
                                <div className='flex flex-col items-center justify-center'>
                    ...
                    <Link href='/thriposha'>
                        <div className='py-3 lg:pt-5 h-[180px] lg:h-[130px] shadow-xl rounded-xl hover:scale-105 ease-in duration-300 backdrop-blur-sm bg-white/70  drop-shadow-md'>
                            <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 justify-center items-center'>
                                <div className='m-auto'>
                                <Image src='/Assets/thriposha.png' width='94' height='94' alt='/' className='rounded-lg'/>
                                </div>
                                <div className='flex flex-col items-center justify-center'>
